# ADR-0002: A decision locked by a Swift suite and method

- **Status:** Accepted
- **Date:** 2026-08-09
- **Lock:** `scripts/adr-fixtures/support/Locked.swift::FixtureSuite/aLockThatResolves`

## Context

The Swift shape the record prefers: suite type plus the method carrying the
`@Test`. It survives a reworded `@Test("...")` phrase, which is the whole
